...
class YOLOv5DetectorEars1(Detector):
    # This YOLOv5 detector detects ears.

    def __init__(self):
        super().__init__()

        self.model_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'training', 'model_batch_8_epoch_150_v5l/weights/best.pt')
