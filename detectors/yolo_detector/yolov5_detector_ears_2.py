...
class YOLOv5DetectorEars2(Detector):
    # This YOLOv5 detector detects ears.

    def __init__(self):
        super().__init__()

        self.model_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'training', 'model_batch_16_epoch_100_v5s/weights/best.pt')
